# Figure 6 level-9 ground-state bounds

- Model: cubic SUSY QM in original `(x,p)` variables.
- Ordinary block: canonical compressed basis `9x9`.
- Ground-state block: canonical compressed basis `5x5`.
...
- Lower feasible points: `9/9`
- Upper feasible points: `9/9`
